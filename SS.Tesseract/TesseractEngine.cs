...
namespace SS.Tesseract
{
    ...
    {
        private static readonly TraceSource trace = new TraceSource("SS.Tesseract");
        ...
        /// for example if your tesseract language data is installed in <c>C:\SS.Tesseract\tessdata</c> the value of datapath should
        /// be <c>C:\SS.Tesseract</c>. Note that tesseract will use the value of the <c>TESSDATA_PREFIX</c> environment variable if defined,
        ...
        /// <summary>
        /// Gets or sets default <see cref="PageSegMode" /> mode used by <see cref="SS.Tesseract.TesseractEngine.Process(Pix, Rect, PageSegMode?)" />.
        /// </summary>
