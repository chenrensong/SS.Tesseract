...
namespace SS.Tesseract
{
    ...
    public class BitmapToPixConverter
    {
        ...
        private void CopyColormap(Bitmap img, Pix pix)
        {
            ...
            System.Drawing.Color ss = new System.Drawing.Color();
            ...
            try
            {
                ...
                {
                    System.Drawing.Color color = System.Drawing.Color.FromArgb(imgPaletteEntries[i].A, imgPaletteEntries[i].R, imgPaletteEntries[i].G, imgPaletteEntries[i].B);
                    if (!pixColormap.AddColor((PixColor)color))
                    {
